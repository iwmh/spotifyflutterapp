...
class ApiAuthRepository {
  ...
  Future<AuthorizationResponse> exchangeAuthorizationCode() async {
    return _apiClient.exchangeAuthorizationCode(
      _clientId,
      _redirectUrl,
    );
  }
  ...
  Future<TokenResponse> exchangeToken(String authorizationCode, String codeVerifier) async {
    return await _apiClient.exchangeToken(
      authorizationCode,
      codeVerifier,
      _clientId,
      _redirectUrl,
  ...
  Future<http.Response> requestToGetPlaylists(Map<String, String> authHeader) async {
    return await _apiClient.requestToGetPlaylists(
      authHeader,
    );
  }
  ...
  Future<http.Response> requestToGetTracksInPlaylist(Map<String, String> authHeader, String url) async {
    return await _apiClient.requestToGetTracksInPlaylist(
      authHeader,
      url,
    );
  }
  ...
  Future<http.Response> requestToGetCurrentUserProfile(Map<String, String> authHeader) async {
    return await _apiClient.requestToGetCurrentUserProfile(
      authHeader,
    );
  }
  ...
  Future<http.Response> requestToGetPlaylistName(Map<String, String> authHeader, String playlistId) async {
    return await _apiClient.requestToGetPlaylistName(
      authHeader,
      playlistId,
    );
  }
  ...
  Future<http.Response> requestToGetPlaylistSnapshotId(Map<String, String> authHeader, String playlistId) async {
    return await _apiClient.requestToGetPlaylistSnapshotId(
      authHeader,
      playlistId,
    );
  }
